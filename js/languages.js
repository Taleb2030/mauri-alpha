...
const translations = {
    ...
    'ar': {
        ...
        'team_taleb_desc': 'أنا مطور واجهات أمامية شغوف مكرس لإنشاء واجهات مستخدم جميلة وسريعة الاستجابة وتجارب مستخدم سلسة. أتخصص في HTML٥ و CSS٣ و JavaScript الحديث لتحويل التصاميم الإبداعية إلى تطبيقات ويب وظيفية وتفاعلية.',

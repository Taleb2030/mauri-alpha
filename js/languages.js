...
const translations = {
    'en': {
        ...
        'team_taleb_desc': 'Specializes in creating beautiful, responsive user interfaces and seamless user experiences. Expert in HTML5, CSS3, and modern JavaScript.',
    ...
    'ar': {
        ...
        'team_taleb_desc': 'يتخصص في إنشاء واجهات مستخدم جميلة وسريعة الاستجابة وتجارب مستخدم سلسة. خبير في HTML5 و CSS3 و JavaScript الحديث.',
    ...
    'fr': {
        ...
        'team_taleb_desc': 'Spécialisé dans la création d\'interfaces utilisateur belles et réactives et d\'expériences utilisateur fluides. Expert en HTML5, CSS3 et JavaScript moderne.',
